import type { baseButtonPropDefs } from '../components/Button/base-button.props';
import type { calloutRootPropDefs } from '../components/callout/callout.props';
import type { spinnerPropDefs } from '../components/spinner/spinner.props';
import type { textPropDefs } from '../components/text/text.props';
