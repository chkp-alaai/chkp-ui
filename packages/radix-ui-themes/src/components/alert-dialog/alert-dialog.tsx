...
import { alertDialogContentPropDefs } from '../accessible-icon/alert-dialog.props';
...
import type { AlertDialogContentOwnProps } from '../accessible-icon/alert-dialog.props';
import type {
